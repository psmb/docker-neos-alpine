...
echo "upload_max_filesize=${PHP_UPLOAD_MAX_FILESIZE:-2048M}" > $PHP_INI_DIR/conf.d/upload_max_filesize.ini
echo "post_max_size=${PHP_UPLOAD_MAX_FILESIZE:-2048M}" > $PHP_INI_DIR/conf.d/post_max_size.ini
